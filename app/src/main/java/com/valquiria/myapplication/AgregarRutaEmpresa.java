...
public class AgregarRutaEmpresa extends AppCompatActivity implements OnMapReadyCallback,View.OnClickListener{
    ...
    private void registros() {
        ...
        if (user != null) {    //Update	user	Info
            ...
            try {
                ...
                myRef.child("fecha").setValue(cal);
                myRef.child("hora").setValue(hora.getText().toString());
                myRef.child("distancia").setValue(dis);
                myRef.child("tiempo").setValue("nublado");
                Toast.makeText(AgregarRutaEmpresa.this, "Ruta guardada",	Toast.LENGTH_SHORT).show();
                mProgress.dismiss();
...
//	Location	settings	are	not	satisfied,	but	this	can	be	fixed	by	showing	the	user	a	dialog.
                        try {//	Show	the	dialog	by	calling	startResolutionForResult(),	and	check	the	result	in	onActivityResult().
                            ...
                            resolvable.startResolutionForResult(AgregarRutaEmpresa.this,
                                    localizacion);
...
*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemClicked == R.id.menuLogOut) {
            mAuth.signOut();
            Intent intent = new Intent(AgregarRutaEmpresa.this, MainActivity.class);
...
//Abrir actividad para	configuración etc
            ...
            Intent intent = new Intent(AgregarRutaEmpresa.this, ModificarUsuario.class);
            //intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
//Abrir actividad para	configuración etc
        }
            ...
            try {
                ...
                if (addresses != null && !addresses.isEmpty() && addresses1 != null && !addresses1.isEmpty()) {
                    ...
                    if (mMap != null) {
                        ...
                        AgregarRutaEmpresa.DownloadTask downloadTask = new AgregarRutaEmpresa.DownloadTask();
                        downloadTask.execute(url);


                    }
                } else {
                    Toast.makeText(AgregarRutaEmpresa.this, "Dirección no encontrada", Toast.LENGTH_SHORT).show();
                }
            } catch (IOException e) {
                e.printStackTrace();
            }
        } else {
            Toast.makeText(AgregarRutaEmpresa.this, "La dirección esta vacía", Toast.LENGTH_SHORT).show();
        }
    ...
    private class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            AgregarRutaEmpresa.ParserTask parserTask = new AgregarRutaEmpresa.ParserTask();
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected List<List<HashMap<String, String>>> doInBackground(String... jsonData) {
            ...
            try {
                ...
                AgregarRutaEmpresa.DirectionsJSONParser parser = new AgregarRutaEmpresa.DirectionsJSONParser();
