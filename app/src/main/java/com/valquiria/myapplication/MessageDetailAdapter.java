...
public class MessageDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MessageDetailAdapter(List<ChatMessage> data, Usuarios friend) {
        this.dataSet = data;
        this.friend= friend;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (holder.getItemViewType()){
            case 0:
                ...
                Log.d(TAG, friend.getNombre());
                Log.d(TAG, friend.getCorreo());
                if(friend.getNombre().length() > 0)
                    holder1.nombre.setText(friend.getNombre());
                else
                    holder1.nombre.setText(friend.getCorreo());
